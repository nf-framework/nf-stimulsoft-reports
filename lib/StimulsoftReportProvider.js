...
export default class StimulsoftReportProvider {
    ...
    async getReport(context, variables, tpl, options) {
        return new Promise((resolve, reject) => {
            const report = this.prerareReport(context, variables, tpl, options);
    ...
    prerareReport(context, variables, tpl, options) {
        ...
        report.onBeginProcessData = (args, cb) => {
            ...
            PostgreSQLAdapter(args, onProcess, context, options);
        }
